...
using ZzukBot.Helpers.IrcDotNet.Collections;
...
namespace ZzukBot.Helpers.IrcDotNet
{
    ...
    public abstract partial class IrcClient : IDisposable
    {
        ...
        private Collections.ReadOnlyDictionary<string, string> serverSupportedFeaturesReadOnly;
        ...
        public Collections.ReadOnlyDictionary<string, string> ServerSupportedFeatures
        {
        ...
        protected virtual void ResetState()
        {
            ...
            this.serverSupportedFeaturesReadOnly = new Collections.ReadOnlyDictionary<string, string>(this.serverSupportedFeatures);
